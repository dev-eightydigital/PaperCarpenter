...
function custom_upload_mimes ( $existing_mimes=array() ) {
 ...
 $existing_mimes['psd'] = 'application/x-psd';
  $existing_mimes['ai'] = 'application/x-ai';
...
__('FootLogo Widget', 'wpb_widget_domain'), 
...
echo __( '<img src="'. get_bloginfo('template_url') .'/images/papercarpenter_footlogo.jpg" alt="" />', 'wpb_widget_domain' );
...
$title = __( 'widget ni', 'wpb_widget_domain' );
}
// Widget admin form
?>
<p>
...
function wpb_load_widget() {
	register_widget( 'footlogo_widget' );
}
...
class MyNewWidget extends WP_Widget {
	...
	function MyNewWidget() {
		...
		parent::__construct( false, 'Social Icons' );
	}

	function widget( $args, $instance ) {
		// Widget output
		?>
		<div class="foot-socialicons">
...
//****************footer social icons widget :end************************
